...
<tr>
	...
	<td align="center"><script>ObjectDraw("page1","button",3,"peview/load new","showAsPopup('builder?middleAction=preview',900,530)","page_section","","images/menu/","",true,24,"35");</script></td>
	<td id="general"> 
<table  cellspacing="0" >
	<tr>
