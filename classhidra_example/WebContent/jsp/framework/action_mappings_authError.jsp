...
<jsp:include page="../included/panel_top.jsp">
	...
	<jsp:param name="panel-onclose" value="document.getElementById('content_Panel_Messages_AMA').style.display='none'" />	
</jsp:include>	
...
<table width="500" bgcolor="white">
			...
			<tr>
				<td colspan="2" align="right" style="cursor: pointer;" onclick="goAction('login.bs?middleAction=clear')">
					<table cellpadding="0" cellspacing="0">
					<tr>
					<td>
					<img src="images/decor/32_profile.gif" border="0">
