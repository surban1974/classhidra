...
public class db_batch_log extends elementDBBase implements i_elementDBBase, java.io.Serializable, i_batch_log {
...
//	TODO @Deprecated
    ...
    protected Integer cd_ist;
    protected String cd_btch;
    protected java.sql.Timestamp tm_start;
    protected java.sql.Timestamp tm_fin;
    protected Integer st_exec;
    protected String dsc_exec;
    
    protected batch_init b_init;
