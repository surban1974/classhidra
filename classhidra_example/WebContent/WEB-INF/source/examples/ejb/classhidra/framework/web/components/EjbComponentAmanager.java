...
public class EjbComponentAmanager extends action implements i_action, Serializable{
...
public redirects actionservice(HttpServletRequest request, HttpServletResponse response) throws ServletException, UnavailableException, bsControllerException {
	...
	EjbComponentAmanager form = this;
...
private void preLoadUsers(EjbComponentAmanager form){
	return;
/*
	try{
...
private void preLoadAuthentications(EjbComponentAmanager form){
	return;
/*
	try{
