...
public class Wrapper_EjbConfig_Users extends bsProvidedWrapper implements i_ProviderWrapper{
	...
	private load_users instance = new load_users();

	public Wrapper_EjbConfig_Users(){
		super();		
		bsController.writeLog("Instanced Ejb Wrapper for [load_users] -> "+this.getClass().getName(), iStub.log_INFO);
	}
