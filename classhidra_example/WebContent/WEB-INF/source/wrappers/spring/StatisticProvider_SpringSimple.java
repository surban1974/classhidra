...
@Component(app_init.id_statistic_provider)
@Scope(value="singleton")
public class StatisticProvider_SpringSimple implements I_StatisticProvider {
	private static final long serialVersionUID = 1L;
	private static LinkedList<StatisticEntity> stack = new LinkedList<StatisticEntity>();
	
	public StatisticProvider_SpringSimple(){
		super();
		bsController.writeLog("Instanced Spring StatisticProvider -> "+this.getClass().getName(), iStub.log_INFO);
	}
