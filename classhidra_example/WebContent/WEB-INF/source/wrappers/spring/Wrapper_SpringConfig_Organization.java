...
@Component(bsConstants.CONST_BEAN_$ORGANIZATION_CONFIG)
@Scope(value="singleton")

public class Wrapper_SpringConfig_Organization extends bsProvidedWrapper {
	private static final long serialVersionUID = 1L;

	private static load_organization instance = new load_organization();

	public Wrapper_SpringConfig_Organization(){
		super();		
		bsController.writeLog("Instanced Spring Wrapper for [load_organization] -> "+this.getClass().getName(), iStub.log_INFO);
	}	
