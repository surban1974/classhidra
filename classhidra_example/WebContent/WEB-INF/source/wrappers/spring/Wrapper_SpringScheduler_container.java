...
@Component(bsConstants.CONST_BEAN_$SCHEDULER_CONTAINER)
@Scope(value="singleton")

public class Wrapper_SpringScheduler_container extends bsProvidedWrapper {
	private static final long serialVersionUID = 1L; 

	private static BatchScheduling instance;

	public Wrapper_SpringScheduler_container(){
		super();		
		bsController.writeLog("Instanced Spring Wrapper for [scheduler_container] -> "+this.getClass().getName(), iStub.log_INFO);
	}
