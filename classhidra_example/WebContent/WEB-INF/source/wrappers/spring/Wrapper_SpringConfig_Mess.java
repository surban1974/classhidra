...
@Component(bsConstants.CONST_BEAN_$MESS_CONFIG)
@Scope(value="singleton")

public class Wrapper_SpringConfig_Mess extends bsProvidedWrapper {
	private static final long serialVersionUID = 1L;

	private static load_message instance = new load_message();

	public Wrapper_SpringConfig_Mess(){
		super();		
		bsController.writeLog("Instanced Spring Wrapper for [load_message] -> "+this.getClass().getName(), iStub.log_INFO);
	}		
