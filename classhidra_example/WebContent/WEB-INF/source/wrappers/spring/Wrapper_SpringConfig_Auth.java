...
@Component(bsConstants.CONST_BEAN_$AUTH_CONFIG)
@Scope(value="singleton")

public class Wrapper_SpringConfig_Auth extends bsProvidedWrapper {
	private static final long serialVersionUID = 1L;

	private static load_authentication instance = new load_authentication();

	
	public Wrapper_SpringConfig_Auth(){
		super();		
		bsController.writeLog("Instanced Spring Wrapper for [load_authentication] -> "+this.getClass().getName(), iStub.log_INFO);
	}		
