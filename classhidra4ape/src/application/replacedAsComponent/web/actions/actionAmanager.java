...
import application.replacedAsComponent.web.forms.formAmanager;





public class actionAmanager extends action implements i_action, Serializable{
	private static final long serialVersionUID = 6641876370416839602L;

public actionAmanager(){
	super();
}
