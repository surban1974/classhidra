...
public class log extends HttpServlet {
	private static final long serialVersionUID = -2566582966508071095L;
	...
	public static synchronized void writeLog(String msg, String userIP, String userMatricola, String classFrom, String level) {
		try{
			if(logG==null) service_mountLog();
			logG.writeLog(msg,userIP,userMatricola,classFrom,level);
		}catch(Exception e){}
	}
	public static synchronized void writeLog(HttpServletRequest _request, String msg, String userIP, String userMatricola, String classFrom, String level){
		try{
			logG.writeLog(_request,msg,userIP,userMatricola,classFrom,level);
		}catch(Exception e){}
	}
