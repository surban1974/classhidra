...
<div >
	<textarea id="xmlContent" name="xmlContent" wrap="off" style="width:100%;height: 93%;overflow:scroll"><bs:formelement name="xmlContent"/> </textarea>
</div>
<table width="100%">
	<tr>
		<td width="50%" align="left" valign="middle" ><font color="red">xml must be inserted into the package /config/ OR into the table = application.config.db (classhidra_app.properties) </font></td>
