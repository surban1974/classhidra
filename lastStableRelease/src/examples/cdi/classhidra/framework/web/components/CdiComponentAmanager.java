...
public class CdiComponentAmanager extends action implements i_action, Serializable{
...
public redirects actionservice(HttpServletRequest request, HttpServletResponse response) throws ServletException, UnavailableException, bsControllerException {
	...
	CdiComponentAmanager form = this;
...
private void preLoadUsers(CdiComponentAmanager form){
	return;
/*
	try{
...
private void preLoadAuthentications(CdiComponentAmanager form){
	return;
/*
	try{
