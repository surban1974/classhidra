...
@Component
@Scope("prototype")
public class SpringComponentAmanager extends action implements i_action, Serializable{
...
public redirects actionservice(HttpServletRequest request, HttpServletResponse response) throws ServletException, UnavailableException, bsControllerException {
	...
	SpringComponentAmanager form = this;
...
private void preLoadUsers(SpringComponentAmanager form){
	return;
/*
	try{
...
private void preLoadAuthentications(SpringComponentAmanager form){
	return;
/*
	try{
