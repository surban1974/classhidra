...
public class EjbComponentProcessBatch extends action implements i_action, Serializable{
...
public EjbComponentProcessBatch(){
	super();
}
...
private void loadBatchs(HttpServletRequest request){
	...
	EjbComponentProcessBatch form = (EjbComponentProcessBatch)get_bean().asBean();
