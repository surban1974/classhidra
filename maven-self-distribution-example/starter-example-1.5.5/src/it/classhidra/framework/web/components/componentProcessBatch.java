...
public class componentProcessBatch extends action implements i_action, i_bean, Serializable{
...
private void loadBatchs(HttpServletRequest request){
	...
	componentProcessBatch form = (componentProcessBatch)get_bean();
