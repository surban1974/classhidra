	...
	if(document.getElementById("content_body_Panel_Popup")){
		...
		if(document.getElementById("tmp_container")){
			ajax_makeRequest(	"popup?type=page",
								"tmp_container",
								function(){
									showAsPopupSubmit(formName,middle,panel_width,panel_height,scroll);
								},
								"",
								false);
		}
	...
	if(document.getElementById("content_body_Panel_Popup")){
		...
		if(document.getElementById("tmp_container")){
			ajax_makeRequest(	"popup?type=page",
								"tmp_container",
								function(){
									showAsPopupSubmitExt(formName,action,panel_width,panel_height,scroll);
								},
								"",
								false);
		}
	...
	if(document.getElementById("content_body_Panel_Popup")){
		...
		if(document.getElementById("tmp_container")){
			ajax_makeRequest(	"popup?type=page",
								"tmp_container",
								function(){
									showAsPopupSubmit_json(formName,middle,panel_width,panel_height,scroll);
								},
								"",
								false);
		}
	...
	if(document.getElementById("content_body_Panel_Popup")){
		...
		if(document.getElementById("tmp_container")){
			ajax_makeRequest(	"popup?type=page",
								"tmp_container",
								function(){
									showAsPopupSubmitExt_json(formName,action,panel_width,panel_height,scroll);
								},
								"",
								false);
		}
...
function showConfirmAsPopup(label,callOk, callKo){
	if(document.getElementById("content_body_Panel_Popup")){
	}else{
		var tmp_container = document.createElement("div");
		tmp_container.id="tmp_container";
		...
		if(document.getElementById("tmp_container")){
			ajax_makeRequest(	"popup?type=page",
								"tmp_container",
								function(){
									showConfirmAsPopup(label,callOk, callKo);
								},
								"",
								false);
		}
