...
<%if(show_close_button){%>	
			<td id="<%=panel_id%>_img_minimize" class="buttonAsJsSmall" align="center" valign="top"  width="22px" style="width:22px;display:none;">
				...
				onclick="showAsPanelNormal('<%=panel_id%>');try{afterShowAsPanelNormal('<%=panel_id%>');}catch(e){};try{document.getElementById('top_menu').style.display='block';}catch(e){}">
			</td>
			<td id="<%=panel_id%>_img_maximize" class="buttonAsJsSmall" align="center" valign="top" width="22px" style="width:22px">
				...
				onclick="showAsPanelMax('<%=panel_id%>');try{afterShowAsPanelMax('<%=panel_id%>');}catch(e){};try{document.getElementById('top_menu').style.display='none';}catch(e){}">
			</td>
