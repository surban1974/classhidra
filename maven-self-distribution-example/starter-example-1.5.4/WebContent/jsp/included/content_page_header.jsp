...
<bs:equal bean="$authentication" method_prefix="" name="is_logged" value="true">						
			...
			<td id="page_img_minimize" align="right" valign="middle" width="1%" style="cursor: pointer; background-image:url('images/corners/panel_t.gif');display:none;">
				...
				onclick="showAsPanelNormal('page');ajax_makeRequest('login-panelmin','','','',false);try{afterShowAsPanelNormal('page');}catch(e){};try{document.getElementById('top_menu').style.display='block';}catch(e){}">
			</td>
			<td id="page_img_maximize" align="right" valign="middle" width="1%" style="cursor: pointer; background-image:url('images/corners/panel_t.gif');">
				...
				onclick="showAsPanelMax('page');ajax_makeRequest('login-panelmax','','','',false);try{afterShowAsPanelMax('page');}catch(e){};try{document.getElementById('top_menu').style.display='none';}catch(e){}">
			</td>
