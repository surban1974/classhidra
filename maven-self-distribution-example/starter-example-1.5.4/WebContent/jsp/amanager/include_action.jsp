			...
			>
				<tr>
					<td width="0%"  valign="middle">
						<img id="img_action_<bs:formelement name="selected_relation.name"/>_<bs:formelement name="selected_action.path"/>" src="images/menu/16_close.gif"/ border="0" style="cursor:pointer"
						onclick="draw_action('<bs:formelement name="selected_relation.name"/>','<bs:formelement name="selected_action.path"/>','',false)">					</td>
...
<bs:equal name="selected_action.enabled" value="1">
	...
	bgcolor="#C1FFC8"
			...
			>
				<tr>
					<td width="0%"  valign="middle">
						<img id="img_action_<bs:formelement name="selected_relation.name"/>_<bs:formelement name="selected_action.path"/>" src="images/menu/16_open.gif"/ border="0" style="cursor:pointer"
						onclick="draw_action('<bs:formelement name="selected_relation.name"/>','<bs:formelement name="selected_action.path"/>','',false)">					</td>
					<td width="100%" class="page_section" style="cursor:pointer"
						onclick="enableEntity('action','<bs:formelement name="selected_relation.name"/>','<bs:formelement name="selected_action.path"/>','','')"
					>
...
<bs:equal bean="current_redirect" name="enabled" value="1">
	bgcolor="#C1FFC8"
			...
			> 							
								<table width="400" cellspacing="0">
									<tr>
										<td width="10" valign="top" class="page_section" style="cursor:pointer"
			...
			bgcolor="#C1FFC8"
									...
									> 
										<table width="400" cellspacing="0">
											<tr>
												<td width="0%" valign="middle"
												 class="page_section" style="cursor:pointer"
