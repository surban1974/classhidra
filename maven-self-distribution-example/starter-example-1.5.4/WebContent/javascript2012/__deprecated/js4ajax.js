...
function dhtmlLoadCss(href,type,rel,charset,media,inbase64,callBackJs){
...
// Javascript way
function dhtmlLoadScript(url,type,rel,charset,inbase64,callBackJs){
...
function dhtmlLoadScript_submit(url,frm,type,rel,charset,inbase64,callBackJs){
	var e = document.createElement("script");
	var parameters;
	if(inbase64){
...
function ajax_submit(frm,target,afterJSFunction,inbase64,callBackJs){
	...
	if(document.getElementById(target) ){
		...
		ajax_makeRequest(frm.action+parameters,target,afterJSFunction,callBackJs);
	}else{
		frm.submit();
	}
}

function ajax_submitExt(frm,action,target,afterJSFunction,inbase64,callBackJs){
	...
	if(document.getElementById(target) ){
		...
		ajax_makeRequest(action+parameters,target,afterJSFunction,callBackJs);
	}else{
		frm.submit();
	}
}
...
//JSON way
function ajax_submit_json(frm,target,afterJSFunction,inbase64,callBackJs){
	...
	if(document.getElementById(target) ){
		...
		ajax_makeJSONRequest(frm.action,json,target,afterJSFunction,callBackJs);
	}else{
		frm.submit();
	}
}

function ajax_submitExt_json(frm,action,target,afterJSFunction,inbase64,callBackJs){
	...
	if(document.getElementById(target) ){
		...
		ajax_makeJSONRequest(action,json,target,afterJSFunction,callBackJs);
	}else{
		frm.submit();
	}
}
...
function ajax_makeJSONRequest(urlWidthParameters,jsonParameters,target,afterJSFunction,callBackJs,showImgBack) {
...
function ajax_submit_mpart(frm,target,afterJSFunction,inbase64,callBackJs){
	if(window.FormData){
		...
		if(document.getElementById(target) ){
			...
			ajax_makeMPARTRequest(frm.action,formdata,target,afterJSFunction,callBackJs);
		}else{
			frm.submit();
		}
	}else{
...
function ajax_submitExt_mpart(frm,action,target,afterJSFunction,inbase64,callBackJs){
	if(window.FormData){
		if(document.getElementById(target) ){
			var formdata;
			if(inbase64)
			...
			ajax_makeMPARTRequest(action,formdata,target,afterJSFunction,callBackJs);
		}else{
			frm.submit();
		}
	}else{
...
function ajax_makeMPARTRequest(urlWidthParameters,formdata,target,afterJSFunction,callBackJs,showImgBack) {
	if(window.FormData){
		var urlOnly="";
