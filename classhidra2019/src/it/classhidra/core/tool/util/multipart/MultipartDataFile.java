...
public class MultipartDataFile extends MultipartData {
	...
	/** file rename policy */
	private MultipartFileRenamePolicy policy;
	...
	*/
	MultipartDataFile(String name, ServletInputStream in, String boundary, String contentType, String fileName, String filePath) throws IOException {
		super(name);
	...
	*/
	public void setRenamePolicy(MultipartFileRenamePolicy policy) {
		this.policy = policy;
	}
	...
	* @exception IOException	if an input or output exception has occurred.
	*/
	public long appendTo(File fileOrDirectory) throws IOException {
