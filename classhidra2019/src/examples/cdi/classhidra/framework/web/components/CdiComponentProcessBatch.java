...
public class CdiComponentProcessBatch extends action implements i_action, i_bean, Serializable{
...
public CdiComponentProcessBatch(){
	super();
}
...
private void loadBatchs(HttpServletRequest request){
	...
	CdiComponentProcessBatch form = (CdiComponentProcessBatch)get_bean();
