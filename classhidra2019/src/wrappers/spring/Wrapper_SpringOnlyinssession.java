...
@Component(bsConstants.CONST_BEAN_$ONLYINSSESSION)
@Scope(value="session")
public class Wrapper_SpringOnlyinssession extends bsProvidedWrapper {
	...
	public Wrapper_SpringOnlyinssession(){
		super();		
		bsController.writeLog("Instanced Spring Wrapper for [onlyinssession] -> "+this.getClass().getName(), iStub.log_INFO);
	}
